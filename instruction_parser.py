    ...
    with open(file_path.rstrip('\r')) as file:
        ...
        for i, line in enumerate(lines):
            ...
            if words[0] == 'A':
                ...
                if(len(words) < 4):
                    print('Cantidad inválida de argumentos en línea ', i+1, '.', end="")
                    print('Terminando ejecución por error de input.')
                    exit()
                instruction = [words[0]]
                ...
                try:
                    ...
                    print("Uno de los argumentos en la línea ", i+1, " no es válido.", end="")
                    print('Terminando ejecución por error de input.')
                    exit()
            elif words[0] == 'P':
                # Checks instruction arguments
                ...
                print("Instruccion inválida en la línea ", i+1, ".", end="")
                print('Terminando ejecución por error de input.')
                exit()
